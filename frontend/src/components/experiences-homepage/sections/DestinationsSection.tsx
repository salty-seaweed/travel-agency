...
export const ExperiencesDestinationsSection: React.FC<Props> = () => {
  ...
  const getImage = (destination: { image?: string; name: string }) => {
        ...
        <Container maxW="7xl">
          <VStack spacing={12}>
            <VStack spacing={4} textAlign="center">
              <Heading size="2xl" color={textColor} fontWeight="bold" className="font-display tracking-tight">
                {t('homepage.destinations.exploreTitle', 'Explore Maldives Destinations')}
              </Heading>
        ...
        <VStack spacing={12}>
          <VStack spacing={4} textAlign="center">
            <Badge colorScheme="blue" variant="subtle" px={4} py={2} borderRadius="full" fontSize="sm" fontWeight="semibold">
              <Icon as={MapPinIcon} className="mr-2 h-4 w-4" />
